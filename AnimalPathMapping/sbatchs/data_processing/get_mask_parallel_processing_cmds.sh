...
## input_mask_folder="/n/davies_lab/Lab/shared_projects/AnimalPathMapping/firestorm-3/image-tiles/just-mask-rgb-tiles/path-mask-tiles/numpy-images"
## input_mask_folder="/n/davies_lab/Lab/shared_projects/AnimalPathMapping/firestorm-3/image-tiles/clipped-relabeled-tiles/tiles-800px/path-mask-tiles/numpy-images"
...
## make sure this folder has already been created
# output_mask_folder="/n/davies_lab/Lab/shared_projects/AnimalPathMapping/firestorm-3/image-tiles/just-mask-rgb-tiles/path-masks-finished"
## output_mask_folder="/n/davies_lab/Lab/shared_projects/AnimalPathMapping/firestorm-3/image-tiles/clipped-relabeled-tiles/tiles-800px/path-masks-finished"
...
commands_to_run_file="mask_parallel_processing_cmds_800tog.sh"
