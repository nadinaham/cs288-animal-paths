...
#SBATCH --gres gpu:1
#SBATCH -o bash-outputs/experiment3-rotated-sep-SYN_mask/%A-%a.out  # File to which STDOUT will be written, %A inserts jobid %a inserts array id
...
output_dir="/n/davies_lab/Lab/shared_projects/AnimalPathMapping/experiment_outputs/experiment-3/SYN_labels_800px_rotated_output"

# set -x
# date
# source ~/.bashrc
python /n/davies_lab/Lab/shared_projects/AnimalPathMapping/cs288-animal-paths/AnimalPathMapping/AnimalPathMapping/models/detectron2/train_test_custom_data_rotate.py $img_dir $mask_dir $output_dir